...
states=pd.read_csv("states2.csv",names=("States", "Standard", "Postal","Capital"),skiprows=1)
columns=["Wine","Beer"]
...
centers.plot.scatter(columns[0],columns[1],colors="red",marker="+",s=200,ax=ax)
...
plt.title("US States Clusterd by Alcohol Consumption")
